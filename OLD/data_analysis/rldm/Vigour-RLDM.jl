...
begin
	...
	pt = 4/3
	cm = inch / 2.54
	set_theme!(merge(theme_minimal(), Theme(font = "Helvetica",
			fontsize = 7pt,
			figure_padding = 10)))
end
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_press_rate_dist.png")
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_press_by_reward_rate_session.pdf")
	save(filepaths, fig)
...
@distinct(vigour_data, prolific_pid, session) |>
x -> @count(x, session)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_press_by_reward_rate_matched_session.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_press_by_reward_rate.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_press_by_conds.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_motor_splithalf_firstsecond.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_motor_splithalf_evenodd.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_retest_motor.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_rppdiff_splithalf_evenodd.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_rppdiff_splithalf_firstsecond.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	RLDM_reliability_scatter!(
		...
		xcol=Symbol(string(1)),
		ycol=Symbol(string(2)),
		subtitle="Reliability: Reward rate sensitivity",
		correct_r=false
	)
	
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_retest_rppdiff.pdf")
	save(filepaths, fig)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_retest_byrpp.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_reg_model_rpp.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_rpp_beta_splithalf_evenodd.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_rpp_beta_splithalf_firstsecond.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_retest_rpp_beta.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_reg_model_fr_n_rm.png")
	save(filepaths, fig; px_per_unit = 4)
...
let
	...
	for s in unique(vigour_data.session)
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_sess$(s)_fr_n_rm_beta_splithalf_evenodd.png")
		save(filepaths, fig; px_per_unit = 4)
...
let
	...
	# Save
	filepaths = joinpath("results/RLDM/vigour", "Vigour_retest_fr_n_rm_beta.png")
	save(filepaths, fig; px_per_unit = 4)
...
begin
	...
	# 7. Create and display the plot
		...
		# Save
		filepaths = joinpath("results/RLDM/vigour", "Vigour_test_acc_by_reward_diff.png")
		save(filepaths, fig; px_per_unit = 4)
...
# Combine all together and save
	...
	CSV.write("results/RLDM/vigour_measures.csv", all_vigour_df)
	all_vigour_df
end
